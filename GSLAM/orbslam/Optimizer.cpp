                                       ...
                                       map<KeyFrame *, set<KeyFrame *> > &LoopConnections)
{
    ...
    // SET LOOP EDGES
    for(map<KeyFrame *, set<KeyFrame *> >::iterator mit = LoopConnections.begin(),
        ...
        mit!=mend; mit++)
    {
        ...
        for(set<KeyFrame*>::iterator sit=spConnections.begin(),
    ...
    for(size_t i=0, iend=vpKFs.size(); i<iend; i++)
    {
        ...
        for(set<KeyFrame*>::iterator sit=sLoopEdges.begin(),
            send=sLoopEdges.end();
            sit!=send; sit++)
        {
            KeyFrame* pLKF = *sit;
